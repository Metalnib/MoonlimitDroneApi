...
namespace Moonlimit.DroneAPI.Test
{
    ...
    public class TokenTest : BaseTest
    {
        ...
        public static async Task token_get(HttpClient client)
        {
            ...
            { //IS4
                ...
                //var response1 = await tokenClient1.RequestClientCredentialsAsync("Moonlimit.DroneAPI");
                //var resp1 = response1.Json;


                //BAD client test
                var response = LoginUsingIdentityServer(is4token, "Moonlimit.DroneAPI-BAD", "secret", "read-write", "my@email.com", "mysecretpassword123");
                ...
                //BAD grant test
                response = LoginUsingIdentityServer(is4token, "Moonlimit.DroneAPIClient", "secret", "read-write", "my@email.com", "mysecretpassword123-BAD");
                ...
                response = LoginUsingIdentityServer(is4token, "Moonlimit.DroneAPIClient", "secret", "read-write", "my@email.com", "mysecretpassword123");
                response_json = response.AccessToken;
                if (response.IsError)
                {
                    Console.WriteLine(response.Error);
    ...
    public class AccountTest : BaseTest
    {
        ...
        public async Task account_getall()
        {
            ...
            Assert.Equal(HttpStatusCode.OK, response.StatusCode);
            var jsonString = await response.Content.ReadAsStringAsync();
            var accounts = (ICollection<CompanyAccountViewModel>)JsonConvert.DeserializeObject<IEnumerable<CompanyAccountViewModel>>(jsonString);
        ...
        public async Task account_getbyid()
        {
            ...
            Assert.Equal(HttpStatusCode.OK, response.StatusCode);
            var jsonString = await response.Content.ReadAsStringAsync();
            var account = JsonConvert.DeserializeObject<CompanyAccountViewModel>(jsonString);
    ...
    public class UserTest : BaseTest
    {
        ...
        public async Task user_getbyid()
        {
            ...
            // lazy-loading test
            response = await client.GetAsync("/api/account/GetAccountWithUsers/" + accountid.ToString());
            response.EnsureSuccessStatusCode();
            Assert.Equal(HttpStatusCode.OK, response.StatusCode);
            jsonString = await response.Content.ReadAsStringAsync();
            var account = JsonConvert.DeserializeObject<CompanyAccountViewModel>(jsonString);
        ...
        public async Task user_getallasync()
        {
            ...
            Assert.True(users.Count > 0);
            // lazy-loading test
            response = await client.GetAsync("/api/accountasync/GetAccountWithUsers/" + accountid.ToString());
            response.EnsureSuccessStatusCode();
            Assert.Equal(HttpStatusCode.OK, response.StatusCode);
            jsonString = await response.Content.ReadAsStringAsync();
            var account = JsonConvert.DeserializeObject<CompanyAccountViewModel>(jsonString);
    ...
    public class Utility
    {
        ...
        public async Task<CompanyAccountViewModel> GetAccount(HttpClient client, int id)
        {
            client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", TokenTest.TokenValue);
